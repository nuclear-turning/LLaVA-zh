...
from transformers import ChineseCLIPVisionModel,ChineseCLIPImageProcessor, StoppingCriteria
...
def eval_model(args):
    ...
    if args.mm_projector is None:
        ...
        vision_tower = ChineseCLIPVisionModel.from_pretrained(args.vision_tower, torch_dtype=torch.float16).cuda()
        image_processor = ChineseCLIPImageProcessor.from_pretrained(args.vision_tower, torch_dtype=torch.float16)
